...
public abstract class DishMocks {
    ...
    public static void initMocks(){
        ...
        dishes.add(new Dish("Omelette des familles", "A ne pas retourner", CourseType.MAIN_COURSE, ingredients));
        dishes.add(new Dish("Pates au poulet", "miam :)", CourseType.MAIN_COURSE, ingredients2));
        dishes.add(new Dish("Yaourt aux fruits", "Perles de lait et mon visage s'est transformé", CourseType.DESSERT, null));
    }
}
